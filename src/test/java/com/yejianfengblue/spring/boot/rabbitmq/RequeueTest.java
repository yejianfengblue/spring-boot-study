 ...
 * Monitor this app log, should see the receiver keeps receiving the same message
...
class RequeueTest {
    ...
    private static final String EXCHANGE_NAME = "spring-boot-study-rabbitmq-requeue-test-exchange";

    private static final String QUEUE_NAME = "spring-boot-study-rabbitmq-requeue-test-queue";
    ...
    @Test
    void givenReceiverAlwaysThrowImmediateRequeueAmqpException_whenSendMessage_thenMessageIsRequeueAndRedeliveredAndRepeat() throws InterruptedException {
